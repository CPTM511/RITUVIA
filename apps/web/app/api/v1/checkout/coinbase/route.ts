...
import { loadWebCoinbaseCheckoutApplicationService } from "../../../../../server/coinbase-checkout";
import {
...
export const POST = async (request: NextRequest): Promise<NextResponse> => {
  ...
  try {
    const result = await loadWebCoinbaseCheckoutApplicationService().createCheckout({
      idempotencyKey,
      request: body,
      sessionToken,
    });
