...
import { listWebAccountHistory, WebAccountError } from "../../../../../server/account";
...
const parseCursor = (
  ...
  if (
    ...
    Object.keys(parsed).sort().join("\u0000") !== "occurredAt\u0000resourceId\u0000sourceType"
  ) {
    throw new TypeError();
  }
  ...
  return Object.freeze({
    ...
    sourceType: candidate.sourceType as
      | "intention"
      | "journal"
      | "journal_legacy"
      | "reading"
...
export const GET = async (request: NextRequest): Promise<NextResponse> => {
  ...
  try {
    ...
    const page = await listWebAccountHistory({
