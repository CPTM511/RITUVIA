        ...
        return await dependencies.persistence.processStripeSandboxEvent(
          {
            ...
            subscriptionCancelAtPeriodEnd: event.subscriptionCancelAtPeriodEnd ?? null,
            subscriptionPeriodEnd: event.subscriptionPeriodEnd ?? null,
            subscriptionPeriodStart: event.subscriptionPeriodStart ?? null,
            subscriptionState: event.subscriptionState ?? null,
